...
})({"c3hPe":[function(require,module,exports) {
...
class NavigationPage {
    constructor(){
        ...
        this.lastScroll = 0;
        let self = this;
        (0, _jqueryMinJsDefault.default)(".nav-tab").click(function() {
            self.onTabClick(event, (0, _jqueryMinJsDefault.default)(this));
        });
        (0, _jqueryMinJsDefault.default)(window).scroll(()=>{
        // this.onScroll();
        });
        (0, _jqueryMinJsDefault.default)(window).resize(()=>{
            this.onResize();
        });
    }
    onTabClick(event1, element) {
        event1.preventDefault();
        let scrollTop = (0, _jqueryMinJsDefault.default)(element.attr("href")).offset().top - this.tabContainerHeight + 1;
        (0, _jqueryMinJsDefault.default)("html, body").animate({
            scrollTop: scrollTop
        }, 600);
    }
    // onScroll() {
    ...
    findCurrentTabSelector(element) {
        ...
        let newCurrentTab;
        let self = this;
        (0, _jqueryMinJsDefault.default)(".nav-tab").each(function() {
            let id = (0, _jqueryMinJsDefault.default)(this).attr("href");
            let offsetTop = (0, _jqueryMinJsDefault.default)(id).offset().top - self.tabContainerHeight;
            let offsetBottom = (0, _jqueryMinJsDefault.default)(id).offset().top + (0, _jqueryMinJsDefault.default)(id).height() - self.tabContainerHeight;
            if ((0, _jqueryMinJsDefault.default)(window).scrollTop() > offsetTop && (0, _jqueryMinJsDefault.default)(window).scrollTop() < offsetBottom) {
                newCurrentId = id;
                newCurrentTab = (0, _jqueryMinJsDefault.default)(this);
            }
        });
    ...
    setSliderCss() {
        ...
        (0, _jqueryMinJsDefault.default)(".nav-tab-slider").css("width", width);
        (0, _jqueryMinJsDefault.default)(".nav-tab-slider").css("left", left);
    }
}
new NavigationPage(); /* Credit and Thanks:
Matrix - Particles.js;
SliderJS - Ettrics;
Design - Sara Mazal Web;
Fonts - Google Fonts
...
},{"../node_modules/jquery/dist/jquery.min.js":"kH14U","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"kH14U":[function(require,module,exports) {
...
},{}]},["c3hPe","lxd7M"], "lxd7M", "parcelRequirea919")
